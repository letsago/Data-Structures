...
protected:
    void RunTests() final
    {
        ...
        ADD_TEST(FrontTest, pyu::shared_ptr<pyu::LinearStorageInterface<int>>(new pyu::Vector<int>));
        ADD_TEST(FrontTest, pyu::shared_ptr<pyu::LinearStorageInterface<int>>(new pyu::LinkedList<int>));
        ADD_TEST(FrontTest, pyu::shared_ptr<pyu::LinearStorageInterface<int>>(new pyu::Array<int, 10>));
...
private:
    ...
    bool FrontTest(pyu::shared_ptr<pyu::LinearStorageInterface<int>> pLsi);
